...
test:
	...
	@docker exec fresh-control-plane bash -c "su - ubuntu -c 'cd server-setup && sudo make control-plane'"
	@echo "Testing Worker..."
	...
	@docker exec fresh-worker bash -c "su - ubuntu -c 'cd server-setup && sudo make worker'"
